...
- **Cloud Integration:** Uses **Supabase (PostgreSQL)** to maintain a persistent state and ensure zero duplicate notifications.
...
- **Automation:** macOS `launchd` background daemon
